...
\title{Waveguide quantum electrodynamics in squeezed vacuum}
\author{Jieyu You, Zeyang Liao\footnote{zeyangliao@physics.tamu.edu}, Sheng-Wen Li, and M. Suhail Zubairy\footnote{zubairy@physics.tamu.edu}}
...
\begin{abstract}
We study the steady state of a $\Xi$-type atom coupled to the squeezed vacuum reservoir and 
\end{abstract}
