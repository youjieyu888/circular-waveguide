...
In this section, we study the steady state of a single atom in the squeezed vacuum reservoir. For a single three level atom, we have $r_i=r_k$, and for simplicity we set $R=r_i=0$. Here we study the case where  $\omega_1+\omega_2=2\omega_0$. It follows from Eq. \eqref{eq1} that various matrix elements satisfy the following equation:
...
\dot{\rho}_{ac}+\dot{\rho}_{ca}={}&-\frac{1}{2}(\gamma_{1}ch^{2}+\gamma_{2}sh^{2})(\rho_{ac}+\rho_{ca})-\sqrt{\gamma_{1}\gamma_{2}}M(\rho_{aa}-2\rho_{bb}+\rho_{cc})
\end{split} \\
\end{align}%
...
\end{split}
\end{equation}
which is a pure state of a superposition of $|a\rangle$ and $|c\rangle$:
\begin{equation}
...
\end{equation}
Since there is no population in the state $|b\rangle$,  population inversion can always occur between states $|a\rangle$ and $|b\rangle$ in the steady state. If $\tanh r>\sqrt{\frac{\gamma_{1}}{\gamma_{2}}}$， population inversion can also occur between the state $|a\rangle$ and $|c\rangle$. This  result is similar to the result in Ref.  \cite{ficek1993two}. However, in our scheme, the population inversion can approach $100\%$ if $\gamma_2\gg\gamma_1$ which beats the population inversion of $78\%$ in Ref. \cite{ficek1993two} because there is no extra damping in our proposal. As we mentioned before, $\gamma_1$ and $\gamma_2$ are controllable if we can control the relative angle between the polarization of the resonant waveguide mode and the atomic dipole moments, so the resultant population inversion can also be controlled. However, in Fick-Drummond's proposal, $TM_n$ and $TE_n$ mode share the same dispersion relation  for parallel-plate waveguides, so there is no way to control the decay rate by aligning one dipole perpendicular to the electric field..
...
\end{equation}
\end{widetext}
Since $ch^{2}A^{2}\gamma{}_{N+1,1,k,1}+sh^{2}C^{2}\gamma{}_{N+1,2,k,2}+2chshCA\gamma'_{N+1,j,k,l}=0$, the extra terms induced by $i=N+1, k=1\sim N$ are 0. The same goes for $i=1\sim N, k=N+1$. Thus, the direct product of the steady state of single atom is also the steady state of the multiple atoms. It is interesting to note that while introducing the dipole-dipole interaction between the atoms affects the evolution of the system, the final steady state still remains unaffected. Therefore,  for multiple atoms, a population inversion of almost $100\%$ can be achieved even the dipole-dipole interaction is considered, under the condition that the dipole direction for all atoms are properly oriented to satisfy $\gamma_{ab}\ll\gamma_{bc}$.
...
\bibitem[{\citenamefont{Svelto}(2010)}]{svelto1998principles}
\bibinfo{author}{\bibfnamefont{O.}~\bibnamefont{Svelto}},
  \emph{\bibinfo{title}{Principles of Lasers}} (\bibinfo{publisher}{Springer
  US}, \bibinfo{year}{2010}).
...
\bibitem[{\citenamefont{Collett and Gardiner}(1984)}]{collett1984mj}
\bibinfo{author}{\bibfnamefont{M.~J.} \bibnamefont{Collett}} \bibnamefont{and}
  \bibinfo{author}{\bibfnamefont{C.~W.} \bibnamefont{Gardiner}},
...
\bibinfo{author}{\bibfnamefont{G.~S.} \bibnamefont{Agarwal}} \bibnamefont{and}
  \bibinfo{author}{\bibfnamefont{R.~R.} \bibnamefont{Puri}},
...
\bibitem[{\citenamefont{Goldstein and Meystre}(1996)}]{goldstein1996ev}
\bibinfo{author}{\bibfnamefont{E.~V.} \bibnamefont{Goldstein}}
...
\bibinfo{author}{\bibfnamefont{H.~J.} \bibnamefont{Carmichael}},
  \bibinfo{author}{\bibfnamefont{A.~S.} \bibnamefont{Lane}}, \bibnamefont{and}
...
\bibinfo{author}{\bibfnamefont{D.~M.} \bibnamefont{Toyli}},
  \bibinfo{author}{\bibfnamefont{A.~W.} \bibnamefont{Eddins}},
...
\bibitem[{\citenamefont{Kruse et~al.}(2016)\citenamefont{Kruse, Lange, Peise,
  L\"ucke, Pezz\`e, Arlt, Ertmer, Lisdat, Santos, Smerzi et~al.}}]{Kruse}
\bibinfo{author}{\bibfnamefont{I.}~\bibnamefont{Kruse}},
  \bibinfo{author}{\bibfnamefont{K.}~\bibnamefont{Lange}},
  \bibinfo{author}{\bibfnamefont{J.}~\bibnamefont{Peise}},
  \bibinfo{author}{\bibfnamefont{B.}~\bibnamefont{L\"ucke}},
  \bibinfo{author}{\bibfnamefont{L.}~\bibnamefont{Pezz\`e}},
  \bibinfo{author}{\bibfnamefont{J.}~\bibnamefont{Arlt}},
  \bibinfo{author}{\bibfnamefont{W.}~\bibnamefont{Ertmer}},
  \bibinfo{author}{\bibfnamefont{C.}~\bibnamefont{Lisdat}},
  ...
  \textbf{\bibinfo{volume}{117}}, \bibinfo{pages}{143004}
  (\bibinfo{year}{2016}).
...
\bibitem[{\citenamefont{Ficek and
  Drummond}(1991{\natexlab{a}})}]{ficek1991three}
...
\bibitem[{\citenamefont{Ficek and
  Drummond}(1991{\natexlab{b}})}]{ficek1991three2}
\bibinfo{author}{\bibfnamefont{Z.}~\bibnamefont{Ficek}} \bibnamefont{and}
  \bibinfo{author}{\bibfnamefont{P.~D.} \bibnamefont{Drummond}},
  \bibinfo{journal}{Phys. Rev. A} \textbf{\bibinfo{volume}{43}},
  \bibinfo{pages}{6258} (\bibinfo{year}{1991}{\natexlab{b}}).

\bibitem[{\citenamefont{Ficek and Drummond}(1993)}]{ficek1993two}
\bibinfo{author}{\bibfnamefont{Z.}~\bibnamefont{Ficek}} \bibnamefont{and}
  \bibinfo{author}{\bibfnamefont{P.~D.} \bibnamefont{Drummond}},
  \bibinfo{journal}{Europhysics Letters ({EPL})} \textbf{\bibinfo{volume}{24}},
  \bibinfo{pages}{455} (\bibinfo{year}{1993}).

\bibitem[{\citenamefont{Turchette et~al.}(1998)\citenamefont{Turchette,
  Georgiades, Hood, Kimble, and Parkins}}]{turchette1998qa}
\bibinfo{author}{\bibfnamefont{Q.~A.} \bibnamefont{Turchette}},
  \bibinfo{author}{\bibfnamefont{N.~P.} \bibnamefont{Georgiades}},
  \bibinfo{author}{\bibfnamefont{C.~J.} \bibnamefont{Hood}},
  \bibinfo{author}{\bibfnamefont{H.~J.} \bibnamefont{Kimble}},
  \bibnamefont{and} \bibinfo{author}{\bibfnamefont{A.~S.}
  \bibnamefont{Parkins}}, \bibinfo{journal}{Phys. Rev. A}
  \textbf{\bibinfo{volume}{58}}, \bibinfo{pages}{4056} (\bibinfo{year}{1998}).

\bibitem[{\citenamefont{Murch et~al.}(2013)\citenamefont{Murch, Weber, Beck,
  Ginossar, and Siddiqi}}]{murch2013kw}
\bibinfo{author}{\bibfnamefont{K.}~\bibnamefont{Murch}},
  \bibinfo{author}{\bibfnamefont{S.}~\bibnamefont{Weber}},
  \bibinfo{author}{\bibfnamefont{K.}~\bibnamefont{Beck}},
  \bibinfo{author}{\bibfnamefont{E.}~\bibnamefont{Ginossar}}, \bibnamefont{and}
  \bibinfo{author}{\bibfnamefont{I.}~\bibnamefont{Siddiqi}},
  \bibinfo{journal}{Nature} \textbf{\bibinfo{volume}{499}}, \bibinfo{pages}{62}
  (\bibinfo{year}{2013}).
...
\bibinfo{author}{\bibfnamefont{V.~I.} \bibnamefont{Yudson}} \bibnamefont{and}
...
\bibitem[{\citenamefont{Liao et~al.}(2016{\natexlab{a}})\citenamefont{Liao,
  Nha, and Zubairy}}]{liao2016dynamical}
\bibinfo{author}{\bibfnamefont{Z.}~\bibnamefont{Liao}},
...
\bibitem[{\citenamefont{Liao et~al.}(2016{\natexlab{b}})\citenamefont{Liao,
  Zeng, Nha, and Zubairy}}]{liao2016review}
\bibinfo{author}{\bibfnamefont{Z.}~\bibnamefont{Liao}},
  \bibinfo{author}{\bibfnamefont{X.}~\bibnamefont{Zeng}},
  \bibinfo{author}{\bibfnamefont{H.}~\bibnamefont{Nha}}, \bibnamefont{and}
  \bibinfo{author}{\bibfnamefont{M.~S.} \bibnamefont{Zubairy}},
...
\bibinfo{author}{\bibfnamefont{D.}~\bibnamefont{Roy}},
  \bibinfo{author}{\bibfnamefont{C.~M.} \bibnamefont{Wilson}},
  \bibnamefont{and}
...
\bibitem[{\citenamefont{Scully and Zubairy}(1997)}]{scully1999quantum}
\bibinfo{author}{\bibfnamefont{M.~O.} \bibnamefont{Scully}} \bibnamefont{and}
  ...
  University Press}, \bibinfo{year}{1997}).
